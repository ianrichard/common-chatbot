...
function getResponseObjectForApiAi(customResponseObject, originalIncomingObjectFromApiAi) {
    ...
    (0, _logJsonToFile2.default)('response-basic-log', responseObjectForApiAi);
    ...
    if (originalIncomingObjectFromApiAi.originalRequest) {
        ...
        if (originalIncomingObjectFromApiAi.originalRequest.source === 'facebook') {
            ...
            (0, _logJsonToFile2.default)('response-facebook-log', responseObjectForApiAi.data.facebook);
            ...
            (0, _logJsonToFile2.default)('response-google-log', responseObjectForApiAi.data.google);
        }
    }

    (0, _logJsonToFile2.default)('response-combined-log', responseObjectForApiAi);
